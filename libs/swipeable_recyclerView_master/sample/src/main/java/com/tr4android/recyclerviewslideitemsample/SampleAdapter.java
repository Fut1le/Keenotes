...
public class SampleAdapter extends SwipeAdapter implements View.OnClickListener {
    ...
    public void onSwipe(int position, int direction) {
        if (direction == SWIPE_LEFT) {
            ...
            Toast toast = Toast.makeText(mContext, "Deleted item_video at position " + position, Toast.LENGTH_SHORT);
            toast.show();
        } else {
            Toast toast = Toast.makeText(mContext, "Marked item_video as read at position " + position, Toast.LENGTH_SHORT);
            toast.show();
        }
    }
    ...
    public void onClick(View view) {
        ...
        Toast toast = Toast.makeText(mContext, "Clicked item_video at position " + position, Toast.LENGTH_SHORT);
        toast.show();
    }
