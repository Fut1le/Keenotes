        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if (list.isEmpty()) {
                ...
                notification = mBuilder
                        .setAutoCancel(true)
                        .setContentTitle("Keenotes_v" + version+".apk")
                        .setColorized(true)
                ...
                Toasty.success(ctxt, "File downloaded and saved at Downloads/Keenotes Updates", Toasty.LENGTH_LONG,true).show();
            }
        }
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse response) {
                        if(isOnline()) {
                            ...
                            request.setTitle("Keenotes");
                            request.setDescription("Downloading ...");
                            request.setVisibleInDownloadsUi(true);
                            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/Keenotes Updates/"+ "Keenotes_v" + version + ".apk");
