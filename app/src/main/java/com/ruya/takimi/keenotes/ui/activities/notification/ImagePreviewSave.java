        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if (list.isEmpty()) {
                ...
                notification = mBuilder
                        ...
                        .setContentText("Image saved at Downloads/Keenotes/" + sender_name)
                        .build();

                notificationManager.notify(0, notification);
                Toasty.success(ctxt, "Image saved at Downloads/Keenotes/" + sender_name, Toasty.LENGTH_LONG,true).show();
            }
        }
       ...
       new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        ...
                        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/Keenotes Images/"+sender_name  + "/KEENOTES_" +  System.currentTimeMillis() + ".jpeg");
