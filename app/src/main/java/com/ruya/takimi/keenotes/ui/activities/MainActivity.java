...
import com.ruya.takimi.keenotes.models.DrawerItem;
import com.ruya.takimi.keenotes.models.Images;
import com.ruya.takimi.keenotes.models.SimpleItem;
import com.ruya.takimi.keenotes.ui.activities.account.LoginActivity;
import com.ruya.takimi.keenotes.ui.activities.account.Notifications;
import com.ruya.takimi.keenotes.ui.activities.account.UpdateAvailable;
import com.ruya.takimi.keenotes.ui.activities.forum.AddQuestion;
import com.ruya.takimi.keenotes.ui.activities.forum.AnswersActivity;
import com.ruya.takimi.keenotes.ui.activities.friends.FriendProfile;
import com.ruya.takimi.keenotes.ui.activities.notification.NotificationActivity;
import com.ruya.takimi.keenotes.ui.activities.notification.NotificationImage;
import com.ruya.takimi.keenotes.ui.activities.notification.NotificationImageReply;
import com.ruya.takimi.keenotes.ui.activities.notification.NotificationReplyActivity;
import com.ruya.takimi.keenotes.ui.activities.post.CommentsActivity;
import com.ruya.takimi.keenotes.ui.activities.post.PostImage;
import com.ruya.takimi.keenotes.ui.activities.post.PostText;
import com.ruya.takimi.keenotes.ui.activities.post.SinglePostView;
import com.ruya.takimi.keenotes.ui.fragment.About;
import com.ruya.takimi.keenotes.ui.fragment.Dashboard;
import com.ruya.takimi.keenotes.ui.fragment.FlashMessage;
import com.ruya.takimi.keenotes.ui.fragment.Forum;
import com.ruya.takimi.keenotes.ui.fragment.FriendsFragment;
import com.ruya.takimi.keenotes.ui.fragment.ProfileFragment;
import com.ruya.takimi.keenotes.utils.Config;
import com.ruya.takimi.keenotes.utils.NetworkUtil;
...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    private BottomSheetDialog mBottomSheetDialogMedia;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (currentuser == null) {
         ...
         //   LinearLayout video_post = sheetView.findViewById(R.id.video_post);
         //   LinearLayout music_post = sheetView.findViewById(R.id.music_post);
            ...
            mBottomSheetDialogMedia = new BottomSheetDialog(this);
            sheetView = getLayoutInflater().inflate(R.layout.bottom_sheet_dialog_media, null);
            mBottomSheetDialogMedia.setContentView(sheetView);
            ...
            video_post.setOnClickListener(view -> {
                mBottomSheetDialogMedia.dismiss();
                Intent intent= new Intent(MainActivity.this, VideoActivity.class);
                startActivity(intent);

            });

            music_post.setOnClickListener(view -> {
                mBottomSheetDialogMedia.dismiss();
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
               ...
               if (intent.getAction().equals(Config.PUSH_NOTIFICATION)) {
                    ...
                    switch (click_action) {
                        case "com.ruya.takimi.keenotes.TARGETNOTIFICATION":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGETNOTIFICATIONREPLY":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGETNOTIFICATION_IMAGE":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGETNOTIFICATIONREPLY_IMAGE":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGET_FRIENDREQUEST":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGET_COMMENT":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGET_UPDATE":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGET_LIKE":
                            ...
                            break;
                        case "com.ruya.takimi.keenotes.TARGET_FORUM":
            ...
            if (resultCode == RESULT_OK && data != null) {
                ...
                new MaterialDialog.Builder(this)
                        ...
                        .onNegative((dialog, which) -> ImagePicker.create(MainActivity.this)
                                ...
                                .theme(R.style.ImagePostTheme)
                                .multi()
                                .limit(7)
                                .showCamera(true)
                                .enableLog(true)
                                .imageDirectory("Keenotes")
